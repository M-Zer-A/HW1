...
public class DeleteDialog extends DialogFragment {
     ...
     * "http://developer.an
     * droid.com/training/basics/fragments/communicating.html"
    ...
    public interface OnDeleteDialogInteractionListener {
        void onDialogPositiveClick(DeleteDialog deleteDialog);

        void onDialogNegativeClick(DeleteDialog deleteDialog);
    }
}
