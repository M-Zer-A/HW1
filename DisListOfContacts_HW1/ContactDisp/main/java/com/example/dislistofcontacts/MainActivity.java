    ...
    public void addClick(View view) {
        ...
        if(taskTitle.isEmpty() && taskDescription.isEmpty()){
            TaskListContent.addItem(new TaskListContent.Task ("Task." + TaskListContent.ITEMS.size() + 1,
                    ...
                    getString(R.string.default_desc),
                    selectedImage));
        }else{
            if(taskTitle.isEmpty())
                taskTitle = getString(R.string.default_title);
            if(taskDescription.isEmpty())
                taskDescription = getString(R.string.default_desc);
        ...
        ((TaskFragment) getSupportFragmentManager().findFragmentById(R.id.taskFragment)).notifyChange();
